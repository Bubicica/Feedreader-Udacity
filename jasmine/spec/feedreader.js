...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
        ...
        */
		it('urls are defined for Feeds', function() {
         ...
         */
		 it('names are defined for Feeds', function() {
			allFeeds.forEach(function(e){
	...
	describe('The menu', function() {
         ...
         */
		it('visibility toggles when clicking the hamburger icon', function() {
	...
	describe('New Feed Selection', function() {
		...
		beforeEach (function(done){
			loadFeed(0, function(){
				...
				firstEle = theFeed.firstElementChild;
				loadFeed(1, function(){
					newFirstEle = theFeed.firstElementChild;
					done();
				});
			});
		});
